...
export class GenerateTables1646655623432 implements MigrationInterface {
    name = 'GenerateTables1646655623432'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "industries" ("id" SERIAL NOT NULL, "description" character varying NOT NULL, "industryFee" double precision NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_f1626dcb2d58142d7dfcca7b8d1" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "consumers" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "fullName" character varying NOT NULL, "birthDate" TIMESTAMP NOT NULL, "phone" character varying, "email" character varying NOT NULL, "cpf" character varying NOT NULL, "password" character varying NOT NULL, "signature" character varying, "signatureRegistered" boolean NOT NULL DEFAULT false, "balance" numeric(10,2) NOT NULL DEFAULT '0', "blockedBalance" numeric(10,2) NOT NULL DEFAULT '0', "emailConfirmated" boolean NOT NULL DEFAULT false, "phoneConfirmated" boolean NOT NULL DEFAULT false, "codeToConfirmEmail" character varying, "deactivedAccount" boolean NOT NULL DEFAULT false, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "addressId" integer, CONSTRAINT "REL_3ffc911cff52ac729e01188ea1" UNIQUE ("addressId"), CONSTRAINT "PK_9355367764efa60a8c2c27856d0" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "transaction_payment_methods" ("id" SERIAL NOT NULL, "cashbackPercentage" double precision NOT NULL DEFAULT '0', "cashbackValue" numeric(10,2) NOT NULL DEFAULT '0', "transactionsId" integer, "paymentMethodId" integer, CONSTRAINT "PK_3d6d4cfd25b7a2628411bd0ebf0" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "payment_plans" ("id" SERIAL NOT NULL, "description" character varying NOT NULL, "value" numeric(10,2) NOT NULL DEFAULT '0', "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_8f05aee900e96c2e0c24df48262" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "companies" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "corporateName" character varying NOT NULL, "fantasyName" character varying NOT NULL, "registeredNumber" character varying NOT NULL, "email" character varying NOT NULL, "phone" character varying NOT NULL, "customIndustryFee" double precision NOT NULL DEFAULT '0', "customIndustryFeeActive" boolean NOT NULL DEFAULT false, "positiveBalance" numeric(10,2) NOT NULL DEFAULT '0', "negativeBalance" numeric(10,2) NOT NULL DEFAULT '0', "monthlyPayment" numeric(10,2) NOT NULL DEFAULT '0', "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "addressId" integer, "industryId" integer, "statusId" integer, "paymentPlanId" integer, CONSTRAINT "REL_2bb6583d4cf35554e19694c8a9" UNIQUE ("addressId"), CONSTRAINT "PK_d4bc3e82a314fa9e29f652c2c22" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "payment_order" ADD CONSTRAINT "FK_8ca8abb331dc065d7100126aa0f" FOREIGN KEY ("paymentMethodId") REFERENCES "payment_method_of_payment_order"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
