...
export class GenerateTables1642088097198 implements MigrationInterface {
    name = 'GenerateTables1642088097198'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "company_payment_methods" ("id" SERIAL NOT NULL, "companyId" uuid NOT NULL, "paymentMethodId" integer NOT NULL, "cashbackPercentage" double precision NOT NULL DEFAULT '0', "isActive" boolean NOT NULL DEFAULT false, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "companyPaymentMethodId" integer, CONSTRAINT "PK_7f9233e77d51ef422b9c7430f6a" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "transaction_payment_methods" ("id" SERIAL NOT NULL, "transactionId" character varying NOT NULL, "paymentMethodId" integer NOT NULL, "cashbackPercentage" double precision NOT NULL DEFAULT '0', "cashbackValue" double precision NOT NULL DEFAULT '0', "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "transactionsId" integer, CONSTRAINT "PK_3d6d4cfd25b7a2628411bd0ebf0" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "company_payment_methods" ADD CONSTRAINT "FK_85a2acb09fe04ec07518337d24c" FOREIGN KEY ("companyPaymentMethodId") REFERENCES "payment_methods"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "company_payment_methods" DROP CONSTRAINT "FK_85a2acb09fe04ec07518337d24c"`);
