...
export class GenerateTables1645276243730 implements MigrationInterface {
    name = 'GenerateTables1645276243730'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "transaction_types" ("id" SERIAL NOT NULL, "description" character varying NOT NULL, "isUp" boolean NOT NULL DEFAULT false, CONSTRAINT "PK_2a49fe7879bf8a02812639cea61" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "transaction_payment_methods" ("id" SERIAL NOT NULL, "cashbackPercentage" double precision NOT NULL DEFAULT '0', "cashbackValue" double precision NOT NULL DEFAULT '0', "transactionsId" integer, "paymentMethodId" integer, CONSTRAINT "PK_3d6d4cfd25b7a2628411bd0ebf0" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "payment_order" ("id" SERIAL NOT NULL, "value" double precision NOT NULL DEFAULT '0', "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "statusId" integer, "companyId" uuid, "paymentMethodId" integer, CONSTRAINT "PK_f5221735ace059250daac9d9803" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "transactions" ("id" SERIAL NOT NULL, "value" double precision NOT NULL, "takebackFeePercent" double precision, "takebackFeeAmount" double precision, "cashbackPercent" double precision, "cashbackAmount" double precision, "keyTransaction" integer, "cancellationDescription" character varying(180), "dateAt" date, "aprovedAt" date, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "transactionTypesId" integer, "transactionStatusId" integer, "consumersId" uuid, "companiesId" uuid, "paymentOrderId" integer, "companyUsersId" uuid, CONSTRAINT "PK_a219afd8dd77ed80f5a862f1db9" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "company_status" ("id" SERIAL NOT NULL, "description" character varying NOT NULL, "blocked" boolean NOT NULL, CONSTRAINT "PK_0004a562592abd6cb0828df61eb" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "companies" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "corporateName" character varying NOT NULL, "fantasyName" character varying NOT NULL, "registeredNumber" character varying NOT NULL, "email" character varying NOT NULL, "phone" character varying NOT NULL, "socialContract" character varying, "acceptanceTerm" character varying, "customIndustryFee" double precision NOT NULL DEFAULT '0', "customIndustryFeeActive" boolean NOT NULL DEFAULT false, "positiveBalance" double precision NOT NULL DEFAULT '0', "negativeBalance" double precision NOT NULL DEFAULT '0', "monthlyPayment" double precision NOT NULL DEFAULT '0', "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "addressId" integer, "industryId" integer, "statusId" integer, "paymentPlanId" integer, CONSTRAINT "REL_2bb6583d4cf35554e19694c8a9" UNIQUE ("addressId"), CONSTRAINT "PK_d4bc3e82a314fa9e29f652c2c22" PRIMARY KEY ("id"))`);
