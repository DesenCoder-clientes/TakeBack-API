...
export class GenerateAllTables1646849541017 implements MigrationInterface {
    name = 'GenerateAllTables1646849541017'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "company_monthly_payment" ("id" SERIAL NOT NULL, "amountPaid" numeric(10,4) DEFAULT '0', "paidDate" date, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "companyId" uuid, "planId" integer, CONSTRAINT "PK_af89d91c5401f744b667ce3b544" PRIMARY KEY ("id"))`);
