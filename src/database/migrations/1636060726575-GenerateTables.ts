...
export class GenerateTables1636060726575 implements MigrationInterface {
    name = 'GenerateTables1636060726575'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "consumer_address" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "street" character varying, "district" character varying, "number" character varying, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "cityId" uuid, CONSTRAINT "PK_c0e86059b3acb674fa2496704d3" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "consumers" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "fullName" character varying NOT NULL, "birthDate" TIMESTAMP NOT NULL, "phone" character varying, "email" character varying NOT NULL, "cpf" character varying NOT NULL, "password" character varying NOT NULL, "signature" character varying, "signatureRegistered" boolean NOT NULL DEFAULT false, "balance" integer NOT NULL DEFAULT '0', "blockedBalance" integer NOT NULL DEFAULT '0', "emailConfirmated" boolean NOT NULL DEFAULT false, "phoneConfirmated" boolean NOT NULL DEFAULT false, "codeToConfirmEmail" character varying, "deactivedAccount" boolean NOT NULL DEFAULT false, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "addressId" uuid, "transactionsId" uuid, CONSTRAINT "REL_3ffc911cff52ac729e01188ea1" UNIQUE ("addressId"), CONSTRAINT "PK_9355367764efa60a8c2c27856d0" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "companies" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "corporateName" character varying NOT NULL, "fantasyName" character varying NOT NULL, "registeredNumber" character varying NOT NULL, "email" character varying NOT NULL, "phone" character varying NOT NULL, "socialContract" character varying, "acceptanceTerm" character varying, "cashbackPercentDefault" integer NOT NULL DEFAULT '0', "balance" integer NOT NULL DEFAULT '0', "blockedBalance" integer NOT NULL DEFAULT '0', "monthlyPayment" integer NOT NULL DEFAULT '0', "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "addressId" uuid, "transactionsId" uuid, "categoryId" uuid, CONSTRAINT "REL_2bb6583d4cf35554e19694c8a9" UNIQUE ("addressId"), CONSTRAINT "PK_d4bc3e82a314fa9e29f652c2c22" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "categories" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "description" character varying NOT NULL, "categoryFee" integer NOT NULL, "iconCategory" integer NOT NULL DEFAULT '1', "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_24dbc6126a28ff948da33e97d3b" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "consumers" ADD CONSTRAINT "FK_13d631f2ecfcdb7a41e3b7f8d7e" FOREIGN KEY ("transactionsId") REFERENCES "transactions"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "companies" ADD CONSTRAINT "FK_2f4241d38ec3ec108e94fc64b8c" FOREIGN KEY ("transactionsId") REFERENCES "transactions"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "companies" ADD CONSTRAINT "FK_c728426d7af44c50be89769c2bd" FOREIGN KEY ("categoryId") REFERENCES "categories"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "companies" DROP CONSTRAINT "FK_c728426d7af44c50be89769c2bd"`);
        await queryRunner.query(`ALTER TABLE "companies" DROP CONSTRAINT "FK_2f4241d38ec3ec108e94fc64b8c"`);
        ...
        await queryRunner.query(`ALTER TABLE "consumers" DROP CONSTRAINT "FK_13d631f2ecfcdb7a41e3b7f8d7e"`);
