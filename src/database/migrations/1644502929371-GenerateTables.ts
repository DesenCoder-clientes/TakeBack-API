...
export class GenerateTables1644502929371 implements MigrationInterface {
    name = 'GenerateTables1644502929371'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "industries" ("id" SERIAL NOT NULL, "description" character varying NOT NULL, "industryFee" double precision NOT NULL, "iconCategory" integer NOT NULL DEFAULT '1', "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_f1626dcb2d58142d7dfcca7b8d1" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "companies" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "corporateName" character varying NOT NULL, "fantasyName" character varying NOT NULL, "registeredNumber" character varying NOT NULL, "email" character varying NOT NULL, "phone" character varying NOT NULL, "socialContract" character varying, "acceptanceTerm" character varying, "customIndustryFee" double precision NOT NULL DEFAULT '0', "customIndustryFeeActive" boolean NOT NULL DEFAULT false, "balance" double precision NOT NULL DEFAULT '0', "blockedBalance" double precision NOT NULL DEFAULT '0', "monthlyPayment" double precision NOT NULL DEFAULT '0', "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "addressId" integer, "industryId" integer, "statusId" integer, CONSTRAINT "REL_2bb6583d4cf35554e19694c8a9" UNIQUE ("addressId"), CONSTRAINT "PK_d4bc3e82a314fa9e29f652c2c22" PRIMARY KEY ("id"))`);
